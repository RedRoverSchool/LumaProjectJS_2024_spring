...
test.describe("Women bottoms page", () => {
    ...
    test("TC 05.2.1_01 Redirection to the Women/Bottoms page after clicking the “Bottoms” droplist category.", async ({
        page,
    }) => {
    ...
    test('TC 05.2.1_02 Breadscrumbs "Home > Women > Bottoms" is displayed on the page', async ({
        page,
    }) => {
        await page.getByText("Women").hover();
        await page.locator("#ui-id-10").click();
